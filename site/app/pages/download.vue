        ...
        versions: [
            {
                ...
                description: ".exe",
                href: "https://github.com/Atia-Farha/Slingshot/releases/latest",
            },
            {
                label: "MSI Installer",
                description: ".msi",
    ...
    <div>
        ...
        >
            ...
            <div class="absolute inset-0">
                ...
                ></div>
                <div
                    class="from-jet absolute inset-x-0 bottom-0 h-32 bg-linear-to-t to-transparent"
                ></div>
            </div>
            ...
            <div class="relative z-10 mx-auto max-w-4xl px-6 text-center">
                ...
                >
                    Download<br />
                    <span class="text-primary">Slingshot</span>
                </h1>
            ...
            <div class="mx-auto max-w-6xl px-6">
                <div class="grid gap-5 sm:grid-cols-3">
                    ...
                    <div
                        ...
                        :key="p.platform"
                        class="group bg-panel hover:border-primary/30 relative overflow-hidden rounded-2xl border border-white/8 transition-all duration-500 hover:shadow-[0_0_60px_-15px_rgba(20,216,212,0.15)]"
                    >
                        ...
                        <!-- Top edge glow -->
                        <div
                            class="absolute inset-x-0 top-0 h-px opacity-0 transition-opacity duration-500 group-hover:opacity-100"
                            style="
                                background: linear-gradient(
                                    90deg,
                                    transparent,
                        ...
                        <div class="relative p-7 text-center">
                            ...
                            <div class="mb-5 flex justify-center">
                                <div
                                    class="text-primary flex h-16 w-16 items-center justify-center rounded-2xl transition-shadow duration-500"
                                    style="
                                        background: radial-gradient(
                                            circle at 50% 50%,
                                            rgba(20, 216, 212, 0.15) 0%,
                                            rgba(20, 216, 212, 0.05) 100%
                                        );
                                    "
                                >
                                    <!-- macOS -->
                                    <svg
                                        v-if="p.platform === 'macos'"
                                        width="32"
                                        height="32"
                                        viewBox="0 0 24 24"
                                        fill="currentColor"
                            ...
                            <!-- Divider -->
                            <div
                                class="mx-auto my-5 h-px w-full max-w-[90%] bg-white/6"
                            ></div>
                            ...
                            <!-- <div class="space-y-2.5">
                                <a
                                    ...
                                    :key="v.label"
                                    :href="v.href"
                                    class="group/link hover:border-primary/40 hover:bg-primary/4 flex items-center justify-between rounded-xl border border-white/6 bg-white/2 px-4 py-3.5 transition-all duration-300 hover:shadow-[0_0_20px_-5px_rgba(20,216,212,0.15)]"
                                >
                                    <div class="flex items-center gap-3">
                                        <div>
                                            ...
                                            <span
                                                v-if="v.description"
                                                class="text-text-muted ml-2 text-xs"
                                                >{{ v.description }}</span
                                            >
                                        </div>
                                    </div>
                                    ...
                                    <svg
                                        ...
                                        stroke-linecap="round"
                                        stroke-linejoin="round"
                                        class="text-primary/60 group-hover/link:text-primary transition-colors duration-300"
                                    >
                                        <path
                                            d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3"
                                        />
